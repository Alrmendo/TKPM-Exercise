...
# NOTE:
- Do lúc làm bài, em tải file zip của project về và làm trên đó (xong em mới để qua file clone và commit lên) nên sẽ có vài file (ví dụ như Log) dữ liệu ghi ra không giống như trong ảnh do em chụp bên file zip em download về ạ. Em cảm ơn thầy. 
