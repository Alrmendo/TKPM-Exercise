...
2. [Cập nhật trong Version 2.0](#2-cập-nhật-trong-version-20)  
   ...
   - [2.3. Hướng dẫn sử dụng](#23-hướng-dẫn-sử-dụng)  
     - [Kết nối cơ sở dữ liệu](#kết-nối-cơ-sở-dữ-liệu-1)  
     - [Quản lý phòng ban](#quản-lý-phòng-ban-1)  
     - [Quản lý chương trình học](#quản-lý-chương-trình-học-1)  
     - [Quản lý trạng thái sinh viên](#quản-lý-trạng-thái-sinh-viên-1)  
     - [Xuất/Nhập dữ liệu](#xuấtnhập-dữ-liệu-1)  
     - [Tìm kiếm nâng cao](#tìm-kiếm-nâng-cao-1)  
